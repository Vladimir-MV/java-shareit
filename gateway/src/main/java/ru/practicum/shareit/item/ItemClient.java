    ...
    public class ItemClient extends BaseClient {
        ...
        public ResponseEntity<Object> findItemSearch (long userId, String text, Integer from, Integer size) {
        ...
        public ResponseEntity<Object> findAllItemsOwner (long userId, Integer from, Integer size) {
            Map<String, Object> parameters = Map.of(
                    "from", from,
                    "size", size
            );
